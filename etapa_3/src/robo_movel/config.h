...
#define MOTOR_BASE_SPEED    15000   /* Base PWM value for straight movement */
#define MOTOR_SPIN_SPEED    19000   /* PWM value for spin/turn maneuvers */
#define MOTOR_TURN_TIME_MS  650     /* Time for 90-degree turn (milliseconds) */
...
#define TCS_INTEGRATION     0xFD    /* Integration time setting */
